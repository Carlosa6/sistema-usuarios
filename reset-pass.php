            ...
            <div class="col-lg-10 my-auto">
                <div class="card-group myShadow">
                    ...
                    <div class="card rounded-right p-4" style="flex-grow: 2;">
                        <h1 class="text-center font-weight-bold textOrange">Enter New Password</h1>
                        <hr class="my-3">
                        <form action="#" method="POST" class="px-3">
                            <div class="text-center text-info lead my-3"><?= $msg; ?></div>
                            <!-- Input New Password -->
                            <div class="input-group input-group-lg form-group">
                                ...
                                <input type="password" name="pass" class="form-control rounded-0" placeholder="New Password" required minlength="6">
                            </div>
                            ...
                            <div class="input-group input-group-lg form-group">
                                ...
                                <input type="password" name="cpass" class="form-control rounded-0" placeholder="Confirm New Password" required minlength="6">
                            </div>

                            <div class="form-group">
                                <input type="submit" value="Reset Password" name="submit" class="btn btn-danger btn-lg btn-block myBtn">
                            </div>
                        </form>
                    </div>
                </div>
